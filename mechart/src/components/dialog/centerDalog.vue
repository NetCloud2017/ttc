<template>
  <div>
    <div class="confirm-dialog" :style="customStyle">
      <div class="confirm-dialog-title">
        <span class="dialog-title">{{title}}</span>
        <i class="icon maliiconfont maliicon-img_comm_cancel dialog-close" src="../../static/ibs/img_comm_close.png" @click.stop="cancel"></i>
      </div>
      ...
      <div class="dialog-option">
        <span class="dialog-confirm" @click.stop="confirm">{{confirmText}}</span>
        <span class="dialog-cancel" @click.stop="cancel">{{cancelText}}</span>
      </div>
    </div>
    <div class="uni-mask" @click.stop="cancel"></div>
  </div>
</template>
<script type="text/ecmascript-6">
  export default {
    ...
    methods: {
      ...
      // 点击取消按钮
      cancel() {
        console.log('centerDialog----cancel-----');
        this.$emit('cancel');
      }
    }
  };
